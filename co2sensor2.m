...
pause(5);            
 ...
 sizeA = [2 inf];
 fileID = fopen('C:\Users\Pedro\Google Drive\Pedro\ifpb\software\sensor1ppm.txt','r','n','UTF-8');
...
t = datestr(t);
fileID = fopen('C:\Users\Pedro\Google Drive\Pedro\ifpb\software\sensor1ppm.txt','a+');
fprintf(fileID,'%d %f\r\n',x,ppmM); %grava o valor da medida e da média no arquivo sensor1
fclose(fileID);
clear ppmM;
clear ppm;
fileID = fopen('C:\Users\Pedro\Google Drive\Pedro\ifpb\software\tempo1.txt','a+');
...
sizeA = [19 inf];
fileID = fopen('C:\Users\Pedro\Google Drive\Pedro\ifpb\software\tempo1.txt','r','n','UTF-8');
